                    ...
                    if(dt.code === 200){
                        ...
                        for(var i=0;i<dt.data.length;i++){
                            ...
                            var html = "<tr>" +
                                            ...
                                            "<td style='text-align: center;'>"+ dt.data[i].enterId +"</td>" +
                                            "<td style='text-align: center;'>" +
                                                "<div class='tpl-table-black-operation'>" +
                                                    "<a href='javascript:;'><i class='am-icon-pencil'></i>重置密码</a>" +
                                                    "<a href='javascript:;' class=\"tpl-table-black-operation-del\"><i class=\"am-icon-trash\"></i>查看</a>" +
                                                    "<a href='javascript:;' class=\"tpl-table-black-operation-del\"><i class=\"am-icon-trash\"></i>编辑</a>" +
